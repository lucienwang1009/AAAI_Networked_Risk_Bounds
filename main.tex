...
\textbf{Moment inequalities for weighted $U$-processes}. We prove moment inequalities for weighted $U$-processes, the general case of incomplete $U$-processes, which involve adding weights on every example.

\textbf{Tight universal bounds}. Using the moment inequality for weighted $U$-processes, we prove universal risk bounds for \problemabbr{} by weighted ERM. These bounds are of the same order of earlier results for complete graphs but tighter for incomplete graphs.

\textbf{Optimization of bounds}. Based on these risk bounds, we propose some optimization programs to design the proper weighting schemes.
...
\todo{Compared with these results, the following three intuitions make our new risk bounds tighter and more general.}
